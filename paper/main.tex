...
Secondly, how to retain information from previous tasks whilst learning new tasks where the tasks aresuch as Continual Learning (CL, \cite{add})
...
\begin{align} \label{eq-laplace-approx-function-space}
 g(\vx) \sim \Norm \left( \mu(\vx), \kappa(\vx, \vx') \right) \quad
  \mu(\vx)
  = \vzeros \quad
