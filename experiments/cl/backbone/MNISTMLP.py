...
class MNISTMLP(MammothBackbone):
    ...
    def __init__(self, input_size: int, output_size: int, width_size: int = 256) -> None:
        """
        ...
        self.fc1 = nn.Linear(self.input_size, width_size)
        self.fc2 = nn.Linear(width_size, width_size)
        ...
        self.classifier = nn.Linear(width_size, self.output_size)
