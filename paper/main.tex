...
As stated in \citet[Lemma~1]{csato2002sparse}, the posterior process $f_{\textrm{post}}$ mean and covariance functions of a GP prior, combined with a likelihood function and $\dataset$ can be parameterized:
