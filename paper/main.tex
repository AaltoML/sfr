...
% i.e. we show these fast updates when using a BNN dynamic model
...
The Laplace approximation \todo{add citation of original paper} constructs a Gaussian approximation of the weight-space posterior $p(\transitionParams_{i} \mid \dataset_{0:i})$
