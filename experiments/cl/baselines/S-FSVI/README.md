...
--n_samples_eval 5 --tau 1.0 --noise_std 1.0 --ind_lim ind_-1_1 --seed 12  --name --init_logvar 0.0 0.0 --init_logvar_lin 0.0 0.0 --init_logvar_conv 0.0 0.0 \
...
--coreset_elbo_offset 0.0 --coreset_entropy_n_mixed 1 --augment_mode constant --n_valid same --loss_type 1
```
#### VCL (with random coresets)
``` bash
python baselines/vcl/run_vcl.py  --dataset smnist_sh --n_epochs 100 --batch_size 256 --hidden_size 256 --n_layers 2  --select_method random_choice --logroot vcl --subdir vcl_smnist200 --n_coreset_inputs_per_task 40 --seed=<SEED>
```
...
--coreset random --coreset_entropy_mode soft_highest --coreset_entropy_offset 0.0 --coreset_kl_heuristic lowest --coreset_kl_offset 0.0 --coreset_elbo_heuristic lowest \
--coreset_elbo_offset 0.0 --coreset_entropy_n_mixed 1  --augment_mode constant --n_valid same  --loss_type 1 --seed <SEED> 
```
#### VCL (with random coresets)
``` bash
  python baselines/vcl/run_vcl.py  --dataset sfashionmnist_sh --n_epochs 100 --batch_size 256 --hidden_size 256 --n_layers 2  --select_method random_choice --logroot vcl --subdir vcl_sfmnist --n_coreset_inputs_per_task 200 --seed=<SEED>
```
...
python cl_v2 --data_training continual_learning_pmnist  --model_type fsvi_mlp --optimizer adam --momentum 0.0 --momentum_var 0.0 \
 ...
 --coreset random --coreset_entropy_mode soft_highest --coreset_entropy_offset 0.0 --coreset_kl_heuristic lowest --coreset_kl_offset 0.0 --coreset_elbo_heuristic lowest \
 --coreset_elbo_offset 0.0 --coreset_entropy_n_mixed 1 --n_permuted_tasks 10 --n_omniglot_tasks 20--augment_mode constant --n_valid same --learning_rate_first_task not_specified --loss_type 1
