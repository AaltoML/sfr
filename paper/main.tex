...
\begin{itemize}
	...
	\item[-] DER: SGD, learning rate 0.03, batch size 10, buffer batch size 10, number epochs 1, $\alpha=0.2$, reservoir buffer size 200.
	\item[-] FROMP: Adam, learning rate $1 \cdot 10^{-4}$, batch size 32, number of epochs 10, $\tau = 10$
	\item[-] S-FSVI: Adam, learning rate 
	\item[-] SFR: Adam
\end{itemize}
