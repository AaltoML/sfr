...
However, encoding functional knowledge in the weights does not guarantees a good quality of the predictions, thus a better to introduce a function-space regularization \citep{li2018lwf, benjamin2018measuring, titsias2019functional, buzzega2020dark, pan2020continual, rudner2022continual}. These methods bridge the gap between objective and reharsal-based methods, since they rely on a subset of the training data for each task to compute the regularization term. Recent methods, such as DER~\cite{buzzega2020dark}, FROMP~\cite{pan2020continual}, and S-FSVI~\cite{rudner2022continual} achieve state-of-the-art performances among the objective-based techniques in several CL benchmarks. 
