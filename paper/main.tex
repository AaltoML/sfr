...
\title{Neural Sparse Gaussian Process: For Updated Exploration}
...
\begin{abstract}
  ...
  % challenge for model-based RL algorithms.
  %
  %Models that can process new information quickly
...
which need to be optimised \parencite{hensmanGaussian2013}.
...
\bibliography{main-blx,zotero-library,bibliography}
\endgroup
