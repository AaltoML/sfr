...
Replacing \cref{eq:dual_param_laplace} in to \cref{eq-laplace-approx-function-space} and we arrive at our GP model based on the converged neural network. 

\textbf{Dual Gaussian Process} A Gaussian process characterizes a distribution over functions in terms of the first two moment. 
