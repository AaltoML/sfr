...
from datasets import SplitFMnistGenerator
from torch.utils.data.dataloader import DataLoader
from utils import select_memorable_points_SH, update_fisher, random_memorable_points
...
def train_splitfmnist(num_tasks, batch_size, hidden_size, lr, num_epochs, num_points,
    ...
    for tid in range(num_tasks):
        ...
        itrainloader = DataLoader(dataset=itrain, batch_size=batch_size, shuffle=True, num_workers=4)
        itestloader = DataLoader(dataset=itest, batch_size=batch_size, shuffle=False, num_workers=4)
        memorableloader = DataLoader(dataset=itrain, batch_size=batch_size, shuffle=False, num_workers=4)
        ...
        if select_method == 'random':
            ...
            i_memorable_points = select_memorable_points_SH(memorableloader, model, num_points=num_points, num_classes=num_classes_per_task,
