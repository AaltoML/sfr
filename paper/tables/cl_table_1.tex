...
\begin{tabular}[c]{c}P-MNIST (SH) \\ 200 points\end{tabular} \\ \midrule
...
{\sc VCL} (with coresets)~\cite{nguyen2018variational} & \val{22.31}{2.00} & \color{blue}{\val{32.11}{1.16}} & \val{53.59}{3.74} &  \val{92.84}{0.34}\\
...
%{\sc L2} & \val{87.48}{0.81} & \val{93.98}{0.17} & \val{81.20}{0.30} & \val{93.89}{0.07}\\
 \hspace{2mm} {\sc L2} (Ours) abl. & \val{88.14}{0.86} & \val{93.90}{0.05} & \val{81.21}{0.36} & \val{94.54}{0.11}\\
\bottomrule
\end{tabular}
