...
def train_splitmnist(num_tasks, batch_size, hidden_size, lr, num_epochs, num_points,
    ...
    for tid in range(num_tasks):
        ...
        itrainloader = DataLoader(dataset=itrain, batch_size=batch_size, shuffle=True, num_workers=1)
        itestloader = DataLoader(dataset=itest, batch_size=batch_size, shuffle=False, num_workers=1)
        memorableloader = DataLoader(dataset=itrain, batch_size=batch_size, shuffle=False, num_workers=1)
