...
\begin{table}[t!] 
  \centering\scriptsize
  \caption{Complements \cref{tbl:uci} in the main paper: Negative log predictive density (NLPD, lower better) for our \our method compared to a GP subset based method which discards most of the data \cite{immer2021improving}. These UCI data sets (num.\ of points $N$, input dim.\ $D$, num.\ classes $C$) demonstrate that even with a small number $M$ of inducing points our method is able to capture good predictive densities.} 
...
\begin{table}[t!] 
  \centering\scriptsize
  \caption{The accuracy of our \our method compared to a GP subset based method which discards most of the data. Even with a small $M$ our method is able to provide good results.} 
