...
(e.g. variational inference) whilst capturing information from all data points, and 2) incorporate new data without retraining (in a computationally efficient manner
