...
\textbf{Function-space updates:} How fast are our function-space updates relative to retraining from scratch? Do they improve predictive performance? \todo{what do we have on this?}
...
%  \hfill
  ...
  %\pgfplotsset{hide axis,legend columns=-1,legend style={draw=none,column sep=1ex,font=\Large}}
  %\input{./fig/uci-legend.tex}\\[-2.5em]
  \caption{Comparison of convergence in terms of negative log-predictive density (NLPD) as averages over $10$-fold cross-validation runs, on UCI classification tasks.}
  \label{fig:uci}
  %\vspace*{-6pt}
\end{figure}
