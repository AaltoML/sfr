...
The dual parameterization states that we can decompose the optimal sparse Gaussian process posterior as follows:
\begin{align}
...
The key quantities we need to build our spaerse GP are $(\alpha_i, \beta_i)$
