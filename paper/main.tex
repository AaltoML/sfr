...
\cref{fig:uci} further shows that as the number of inducing points is lowered $M=512 \rightarrow 16$, \our is able to maintain a much better NLPD than the GP subset.
