from train_splitfmnist_SH import train_splitfmnist
import argparse
import torch
import numpy as np
import copy
...
def main(args):
    ...
    acc = train_splitfmnist(num_tasks=args.num_tasks, batch_size=args.batch_size, hidden_size=args.hidden_size,
...
if __name__ == '__main__':
    ...
    for i in range(args.num_runs):
        ...
        print('\nSplit FashionMNIST, seed', args.seed+i)
