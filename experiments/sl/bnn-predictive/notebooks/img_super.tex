...
\sc FMNIST and SVGP (3200) & \val{0}{0} & \val{0}{0} & \val{0}{0} & \val{0}{0} \\
\sc FMNIST and SVGP NN (3200) & \val{0}{0} & \val{0}{0} & \val{0}{0} & \val{0}{0} \\
...
\sc CIFAR10 and SVGP (100) & \val{70.36}{0.992} & \val{0.939}{0.019} & \val{0.152}{0.009} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP NN (100) & \val{75.872}{0.22} & \val{0.764}{0.007} & \val{0.119}{0.002} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP (500) & \val{75.784}{0.513} & \val{0.764}{0.015} & \val{0.111}{0.005} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP NN (500) & \val{76.252}{1.055} & \val{0.731}{0.018} & \val{0.093}{0.013} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP (1000) & \val{77.696}{0.488} & \val{0.666}{0.015} & \val{0.018}{0.005} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP NN (1000) & \val{77.772}{0.511} & \val{0.667}{0.016} & \val{0.019}{0.009} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP (3200) & \val{78.112}{0.656} & \val{0.666}{0.028} & \val{0.026}{0.011} & \val{0.0}{0.0} \\
\sc CIFAR10 and SVGP NN (3200) & \val{77.772}{0.511} & \val{0.667}{0.016} & \val{0.019}{0.009} & \val{0.0}{0.0} \\
\bottomrule
\end{tabular}
