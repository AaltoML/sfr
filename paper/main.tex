...
where $\tilde{\lambda}_i = \alpha_i - \myexpect_{q_{\vu}(f)}[f_i] \beta_i$ with $(\hat{\alpha}_i, \hat{\beta}_i)$ defined as follows,
\begin{equation}
