...
%  \hfill
  ...
  \caption{Comparison of convergence in terms of number of inducing data points $M$ in NLPD (mean over 10 random splits) on UCI classification tasks: \our (thick) vs.\ subsets (thin). The orange lines (\myline{darkorange25512714}) use the GP mean, whereas the blue lines (\myline{steelblue31119180}) the NN MAP estimate as the mean. Our \our's converges fast for all cases.}
  \label{fig:uci}
  %\vspace*{-6pt}
\end{figure}
