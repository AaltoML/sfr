...
For the weight-space methods, we considered EWC~\citep{kirkpatrick2017overcoming}, SI~\citep{zenke2017continual}, and VCL~\citep{nguyen2018variational}.  % In \cref{tbl:cl_table_1}, we considered VCL with random coresets, which uses coreset points t 
