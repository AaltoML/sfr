...
In our experiments, we parameterised the value function as an MLP with two hidden layers of width $128$ with ELU activations and the actor as an MLP with two hidden layers of width $128$ with ELU activations.
...
\cref{fig:rl} also shows that DDPG does not converge to the same asymptotic performance as \sfr.
