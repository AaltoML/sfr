...
\begin{wraptable}{R}{.65\textwidth}
  \centering\scriptsize
  \caption{Continual learning experiments (acc.). $^*$ Methods relying only on weight regularization. \color{blue}{Results from \cite{rudner2022continual}.}}
...
% that \our's uncertainty estimates are useful for guiding exploration as it converges in fewer episodes.
