...
%  \hfill
  ...
  \caption{Comparison of convergence in terms of number of inducing data points $M$ in NLPD (mean over 10 random splits) on UCI classification tasks: \our (thick) vs.\ subsets (thin). The blue lines (\myline{steelblue31119180}) use the NN mean, whereas the orange lines (\myline{steelblue31119180}) use the GP mean. Our \our's converges fast for all cases.}
  \label{fig:uci}
  %\vspace*{-6pt}
\end{figure}
